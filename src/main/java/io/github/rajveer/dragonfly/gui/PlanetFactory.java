...
public class PlanetFactory {
    ...
    public static void createPlanets(Group root, double[] radii, double[] initialState, String[] names) {
        ...
        for (int i = 0; i < names.length; i++) {
            ...
            Sphere planet = new Sphere(radii[i] * SolarSystemData.SIZE_SCALE);
            planet.setTranslateX(xKm * SolarSystemData.DISTANCE_SCALE);
            planet.setTranslateY(-zKm * SolarSystemData.DISTANCE_SCALE);
            planet.setTranslateZ(yKm * SolarSystemData.DISTANCE_SCALE);
